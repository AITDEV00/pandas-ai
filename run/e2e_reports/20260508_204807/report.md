...
**Generated:** 2026-05-08 20:48:19
**Report directory:** `/home/jyao/ADEO/services/ait-icarus/pandas-ai/run/e2e_reports/20260508_204807`
...
**Conversation ID:** `76ee8858-bf3b-47f0-910c-522360aad781`
...
| Avg LLM calls per query | 1.0 |
| Max LLM calls per query | 1 |
...
|----|-------|----------|------------|---------|--------|-----------|
| HS-001 | What is the exact Etihad Allowance amoun... | handoff_sabotage | extreme | ✅ | fence | 1 |
