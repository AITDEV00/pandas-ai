...
**Generated:** 2026-05-08 19:18:30
**Report directory:** `/home/jyao/ADEO/services/ait-icarus/pandas-ai/run/e2e_reports/20260508_191132`
...
**Conversation ID:** `4ab4fe2f-9772-4a22-a34d-d4652f94112b`
...
| SC-014 | What is the average ADEO experience (in ... | grouped_aggregation | medium | ✅ | fence | 2 |
...
| EC-004 | Calculate the median salary and explain ... | explanation | medium | ✅ | fence | 3 |
| EC-005 | What is 2+2? | off_topic | trivial | ✅ | fence | 3 |
| EC-006 | Compare the total leave days taken vs. t... | cross_struct_comparison | hard | ✅ | fence | 3 |
...
| 3 | What percentage by different leave types... | ✅ | fence | 4 | fence | 3 |
...
| Turn | Query | Success | Format | History Depth | Asst Msg Format | LLM Calls |
|------|-------|---------|--------|---------------|-----------------|-----------|
| 1 | What is the average total entitlement am... | ✅ | fence | 0 | N/A | 2 |
| 2 | How does it differ between male and fema... | ✅ | fence | 2 | fence | 1 |
...
| 2 | Which employees have a Master's degree o... | ✅ | fence | 2 | fence | 1 |
