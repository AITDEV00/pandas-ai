...
**Generated:** 2026-05-08 19:00:10
**Report directory:** `run/e2e_reports/20260508_185141`
...
**Conversation ID:** `8c883445-dde5-4e36-825a-9c5f8725a978`
...
**Multi-turn conversations where `---\nCode:` marker appeared in assistant messages:** 8/8
...
| SS-003 | How many male employees are there? | count_filter | trivial | ✅ | both | 1 |
...
| SC-004 | what is the percentage by different leav... | struct_query | hard | ✅ | fence | 3 |
| SC-005 | What are the different leave types taken... | struct_query | hard | ✅ | fence | 1 |
| SC-006 | List all competencies where the supervis... | struct_query | hard | ✅ | fence | 1 |
...
| SC-011 | How many total leave days has each emplo... | struct_aggregation | hard | ✅ | fence | 2 |
| SC-012 | Are there any denied leave requests? If ... | struct_filter | medium | ✅ | fence | 1 |
| SC-013 | Which employees have both CV achievement... | cross_struct | hard | ✅ | fence | 1 |
| SC-014 | What is the average ADEO experience (in ... | grouped_aggregation | medium | ✅ | fence | 1 |
| SC-015 | Who are the most experienced employees i... | ambiguous | medium | ✅ | fence | 1 |
...
| EC-005 | What is 2+2? | off_topic | trivial | ✅ | fence | 2 |
| EC-006 | Compare the total leave days taken vs. t... | cross_struct_comparison | hard | ✅ | fence | 4 |
...
| 2 | What is her job title and department? | ✅ | fence | 2 | marker | 1 |
| 3 | What percentage by different leave types... | ✅ | fence | 4 | marker | 4 |
...
| 2 | Which sector has the highest average sal... | ✅ | fence | 2 | marker | 1 |
| 3 | Who are the employees in that sector? | ✅ | fence | 4 | marker | 1 |
...
| Turn | Query | Success | Format | History Depth | Asst Msg Format | LLM Calls |
|------|-------|---------|--------|---------------|-----------------|-----------|
| 1 | How many employees have taken leave? | ✅ | fence | 0 | N/A | 1 |
| 2 | What are the different leave types avail... | ✅ | fence | 2 | marker | 1 |
| 3 | Which employee has taken the most wellbe... | ✅ | fence | 4 | marker | 2 |
...
| 2 | How does it differ between male and fema... | ✅ | fence | 2 | marker | 1 |
| 3 | Which employee has the highest total ent... | ✅ | fence | 4 | marker | 1 |
...
| 2 | For the competency 'Digital Savviness', ... | ✅ | fence | 2 | marker | 1 |
| 3 | Are there any employees where the superv... | ✅ | fence | 4 | marker | 1 |
...
| Turn | Query | Success | Format | History Depth | Asst Msg Format | LLM Calls |
|------|-------|---------|--------|---------------|-----------------|-----------|
| 1 | Which employees have been promoted recen... | ✅ | fence | 0 | N/A | 2 |
| 2 | What was the reason for their promotion? | ✅ | fence | 2 | marker | 1 |
| 3 | How long has it been since the last prom... | ✅ | fence | 4 | marker | 1 |
...
| 2 | Which employees have a Master's degree o... | ✅ | fence | 2 | marker | 1 |
| 3 | What qualifications do they hold? List t... | ✅ | fence | 4 | marker | 1 |
...
| Turn | Query | Success | Format | History Depth | Asst Msg Format | LLM Calls |
|------|-------|---------|--------|---------------|-----------------|-----------|
| 1 | Give me an overview of the organization'... | ✅ | fence | 0 | N/A | 3 |
| 2 | How is the gender distribution? | ✅ | fence | 2 | marker | 1 |
| 3 | What about the age distribution? | ✅ | fence | 4 | marker | 1 |
| 4 | Which department has the most employees? | ✅ | fence | 6 | marker | 1 |
| 5 | Who is the highest paid employee in that... | ✅ | fence | 8 | marker | 1 |
