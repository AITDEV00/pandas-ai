...
**Generated:** 2026-05-08 20:58:38
**Report directory:** `/home/jyao/ADEO/services/ait-icarus/pandas-ai/run/e2e_reports/20260508_204900`
...
**Conversation ID:** `81b4bee5-fe4c-48c0-8971-8285f5fc36ec`
...
|----|-------|----------|------------|---------|--------|-----------|
| HS-001 | What is the exact Etihad Allowance amoun... | handoff_sabotage | extreme | ✅ | no_code_delimiter | 4 |
...
| HS-006 | What is the Total Entitlement Amount for... | handoff_sabotage | hard | ✅ | no_code_delimiter | 2 |
...
| TC-001 | Show the Start Date from Employee Assign... | triple_name_collision | extreme | ✅ | no_code_delimiter | 4 |
| TC-002 | Compare the End Date from Employee Assig... | triple_name_collision | extreme | ✅ | no_code_delimiter | 4 |
| TC-003 | Show the Job Title from Employee Master ... | triple_name_collision | extreme | ✅ | no_code_delimiter | 5 |
| TC-004 | What is the Employee Grade from Employee... | triple_name_collision | hard | ✅ | fence | 5 |
| TC-005 | Show the Assignment Name from Employee A... | triple_name_collision | hard | ✅ | no_code_delimiter | 4 |
| TC-006 | List the CV Degree Name from CV Employee... | triple_name_collision | hard | ✅ | fence | 5 |
...
| AM-003 | What is the Cost of Living Allowance for... | allowance_matrix | medium | ✅ | no_code_delimiter | 2 |
| AM-004 | What is the Social Allowance for all emp... | allowance_matrix | medium | ✅ | no_code_delimiter | 3 |
| AM-005 | What is the Child Allowance for all empl... | allowance_matrix | medium | ✅ | no_code_delimiter | 2 |
| AM-006 | What is the Supplementary Allowance for ... | allowance_matrix | medium | ✅ | fence | 4 |
| AM-007 | What is the Phone Allowance for all empl... | allowance_matrix | medium | ✅ | fence | 2 |
| AM-008 | What is the Etihad Allowance for all emp... | allowance_matrix | hard | ✅ | fence | 3 |
...
| AM-011 | What is the Special Contract Basic Salar... | allowance_matrix | hard | ✅ | fence | 3 |
| MJ-001 | For each employee, show their most recen... | multi_struct_join | extreme | ✅ | fence | 5 |
...
| MJ-004 | Show the CV education degree alongside t... | multi_struct_join | hard | ✅ | fence | 6 |
...
| MJ-007 | For employees who have both Employee Ach... | multi_struct_join | hard | ✅ | fence | 2 |
| NT-001 | Which employees have a ZERO Etihad Allow... | negation_trap | hard | ✅ | no_code_delimiter | 2 |
| NT-002 | Which employees have NO Secondment Allow... | negation_trap | hard | ✅ | fence | 2 |
| NT-003 | Show employees who do NOT have any leave... | negation_trap | hard | ✅ | fence | 2 |
| NT-004 | Which employees have never been promoted... | negation_trap | medium | ✅ | no_code_delimiter | 2 |
| NT-005 | List employees who have ZERO sick leave ... | negation_trap | medium | ✅ | no_code_delimiter | 2 |
